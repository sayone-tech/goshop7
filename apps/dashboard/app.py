...
class DashboardApplication(Application):
    ...
    def get_urls(self):
        ...
        urlpatterns2 = patterns('',
            url(r'^$', django_staff_member_required(self.index_view.as_view()), name='index'),
            )
        return urlpatterns2+self.post_process_urls(patterns('', *urls))


dashapplication = DashboardApplication()
